...
class BambuPrinterCard extends HTMLElement {
  ...
  _css() { return `
    ...
    *{box-sizing:border-box;margin:0;padding:0;font-family:var(--primary-font-family,-apple-system,sans-serif)}
    ...
    .humrow{display:flex;align-items:center;justify-content:space-between;padding-top:7px;margin-top:2px;border-top:1px solid rgba(255,255,255,.07)}
  ...
  _buildPrinter() {
    ...
    return `<div class="card">
      <div class="sbanner" style="background:rgba(${st.rgb},.05);border-bottom:1px solid rgba(${st.rgb},.1)">
