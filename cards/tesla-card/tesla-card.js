...
class TeslaCard extends HTMLElement {
  ...
  static getConfigForm() {
    return {
      ...
      assertCustomElement: 'tesla-card',
    };
  }
  ...
  _openPopup() {
    ...
    popup.innerHTML = `
      ...
      <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:16px">
        <div>
          <div style="font-size:17px;font-weight:700;color:white;line-height:1.2">${this._config.name}</div>
          <div style="font-size:11px;color:rgba(255,255,255,0.4);margin-top:3px">Vehicle details</div>
        </div>
        <button id="tc-close" style="background:rgba(255,255,255,0.18);border:none;border-radius:50%;width:28px;height:28px;cursor:pointer;display:flex;align-items:center;justify-content:center;color:rgba(255,255,255,0.5);font-size:14px;line-height:1;font-family:inherit">✕</button>
      </div>
