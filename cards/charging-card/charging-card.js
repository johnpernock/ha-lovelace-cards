...
class ChargingCard extends HTMLElement {
  ...
  _css() { return `
    ...
    *{box-sizing:border-box;margin:0;padding:0;font-family:var(--primary-font-family,-apple-system,sans-serif)}
    ...
    .idle-dot{width:9px;height:9px;border-radius:50%;background:rgba(255,255,255,.75);flex-shrink:0;margin-top:3px}
  ...
  _renderCharging() {
    ...
    return `
      <div class="banner" style="background:rgba(255,255,255,0);border-bottom-color:rgba(96,165,250,.45)">
